...
constexpr auto neareast_power_of_2(std::size_t num) noexcept -> std::size_t {
	...
	inline static constexpr auto combine_two_blocks(
		...
		return BlockInfo::max_value * a1 + a0;
	}
	...
	inline static constexpr auto split_into_blocks(
		...
		BlockInfo::type a0 = n % BlockInfo::max_value;
		auto temp = n / BlockInfo::max_value;
		BlockInfo::type a1 = temp % BlockInfo::max_value;

		return { a0, a1, static_cast<BlockInfo::type>(temp / BlockInfo::max_value) };
	}
